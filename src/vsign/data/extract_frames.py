...
def parse_args():
    ...
    parser.add_argument('--video_root', default="/home/kafka/Desktop/v-sign/data/raw/VSL_V2", type=str)
    parser.add_argument('--output_root', default="/home/kafka/Desktop/v-sign/data/interim/frames/VSL_V2", type=str)
    parser.add_argument('--csv_root', default="/home/kafka/Desktop/v-sign/data/splits/VSL_V2/csv", type=str)
